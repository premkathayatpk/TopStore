...
const AddProduct = ({ onClose }) => {
  ...
  const handleImageChange = (e) => {
    ...
    setFormData((prev) => ({ ...prev, productImg: file }));
  };

  const handleRemoveImage = () => {
    setImagePreview(null);
    setFormData((prev) => ({ ...prev, productImg: null }));
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-blur-xs p-4 overflow-y-auto">
      <div className="w-full max-w-max mx-auto  bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden relative my-auto">
        <button
          onClick={onClose}
          type="button"
        ...
        <form className="px-6 py-2 space-y-4" onSubmit={handleSubmit}>
          <div className="space-y-2">
            ...
            {!imagePreview ? (
              <div className="flex justify-center px-6 pt-3 pb-6 border-2 border-gray-300 border-dashed rounded-md hover:border-gray-400 cursor-pointer group relative">
